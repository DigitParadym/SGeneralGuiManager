...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def _connect_signals(self):
        ...
        self.add_files_btn.clicked.connect(self.add_files_to_modular)  # Updated to connect to new method
        ...
        try:
            ...
            if result.returncode == 0:
                reply = QtWidgets.QMessageBox.question(
                    ...
                    'Script executed successfully. Clear discussions and modular files for next run?',
                    QtWidgets.QMessageBox.Yes | QtWidgets.QMessageBox.No,
                    QtWidgets.QMessageBox.Yes
                )
                
                status_parts = [f"Script executed successfully from {script_dir}"]
                if modular_files:
                ...
                if reply == QtWidgets.QMessageBox.Yes:
                    ...
                    self.status_label.setText("Execution complete. Fields cleared for next run.")
            else:
