...
from core.models import TransformationModel, TransformationPlanModel, validate_plan_file
...
class TestTransformationModel:
    ...
    def test_plugin_manquant_pour_appel_plugin(self):
        ...
        data = {"type": "appel_plugin", "description": "Sans plugin"}
    ...
    def test_champ_supplementaire_rejete(self):
        ...
        assert ("extra fields not permitted" in msg) or ("extra inputs are not permitted" in msg)
...
class TestTransformationPlanModel:
    ...
    def test_plan_sans_nom_leve_erreur(self):
        ...
        plan_data = {"description": "Plan sans nom.", "version": 1.0, "transformations": []}
        with pytest.raises(ValidationError):
