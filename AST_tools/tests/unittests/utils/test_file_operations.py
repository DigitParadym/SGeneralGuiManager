...
# -*- coding: utf-8 -*-
"""
Tests pour operations fichiers
==============================

Tests unitaires pour file_operations
...
class TestFileOperations(unittest.TestCase):
    """
    Classe de tests pour file_operations
    """
...
class TestFileOperationsIntegration(unittest.TestCase):
    """
    Tests d'integration pour file_operations
    """
...
def suite():
    ...
    test_suite.addTest(unittest.makeSuite(TestFileOperationsIntegration))
