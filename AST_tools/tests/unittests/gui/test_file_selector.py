...
# -*- coding: utf-8 -*-
"""
Tests pour FileSelector
=======================

Tests unitaires pour file_selector
...
class TestFileSelector(unittest.TestCase):
    """
    Classe de tests pour file_selector
    """
...
class TestFileSelectorIntegration(unittest.TestCase):
    """
    Tests d'integration pour file_selector
    """
...
def suite():
    ...
    test_suite.addTest(unittest.makeSuite(TestFileSelector))
    
    # Ajouter les tests d'integration
    test_suite.addTest(unittest.makeSuite(TestFileSelectorIntegration))
