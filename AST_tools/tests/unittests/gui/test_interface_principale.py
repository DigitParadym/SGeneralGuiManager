...
# -*- coding: utf-8 -*-
"""
Tests pour InterfaceAST
=======================

Tests unitaires pour interface_principale
...
class TestInterfacePrincipale(unittest.TestCase):
    """
    Classe de tests pour interface_principale
    """
...
class TestInterfacePrincipaleIntegration(unittest.TestCase):
    """
    Tests d'integration pour interface_principale
    """
...
def suite():
    ...
    test_suite.addTest(unittest.makeSuite(TestInterfacePrincipale))
    
    # Ajouter les tests d'integration
    test_suite.addTest(unittest.makeSuite(TestInterfacePrincipaleIntegration))
