...
Tests unitaires pour integration
...
class TestIntegration(unittest.TestCase):
    """
    Classe de tests pour integration
    """
...
class TestIntegrationIntegration(unittest.TestCase):
    """
    Tests d'integration pour integration
    """
...
def suite():
    ...
    test_suite.addTest(unittest.makeSuite(TestIntegrationIntegration))
