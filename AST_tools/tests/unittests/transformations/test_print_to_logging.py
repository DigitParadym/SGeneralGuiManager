...
# -*- coding: utf-8 -*-
"""
Tests pour PrintToLoggingTransform
==================================

Tests unitaires pour print_to_logging
...
class TestPrintToLogging(unittest.TestCase):
    """
    Classe de tests pour print_to_logging
    """
...
class TestPrintToLoggingIntegration(unittest.TestCase):
    """
    Tests d'integration pour print_to_logging
    """
...
def suite():
    ...
    test_suite.addTest(unittest.makeSuite(TestPrintToLogging))
    
    # Ajouter les tests d'integration
    test_suite.addTest(unittest.makeSuite(TestPrintToLoggingIntegration))
