...
# -*- coding: utf-8 -*-
"""
Tests pour JsonAITransformer
============================

Tests unitaires pour json_ai_transformer
...
class TestJsonAiTransformer(unittest.TestCase):
    """
    Classe de tests pour json_ai_transformer
    """
...
class TestJsonAiTransformerIntegration(unittest.TestCase):
    """
    Tests d'integration pour json_ai_transformer
    """
...
def suite():
    ...
    test_suite.addTest(unittest.makeSuite(TestJsonAiTransformer))
    
    # Ajouter les tests d'integration
    test_suite.addTest(unittest.makeSuite(TestJsonAiTransformerIntegration))
