...
class BowlerTransformers:
    ...
    def apply_transformer(self, transformer_name: str, file_path: Path,
    ...
    def print_to_logging(self, file_path: Path, dry_run: bool = True,
    ...
    def update_deprecated_apis(self, file_path: Path, dry_run: bool = True,
                              api_mapping: Dict[str, str] = None) -> bool:
        """
    ...
    def batch_transform(self, file_paths: List[Path],
