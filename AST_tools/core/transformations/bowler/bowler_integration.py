...
try:
    from bowler import Query, BowlerException
...
class BowlerIntegration:
    ...
    def apply_transformation(self, query: Query, 
                           transformation_func: callable,
                           dry_run: bool = None) -> bool:
        """
    ...
    def transform_file(self, file_path: Union[str, Path],
                      selector: str, modifier: callable,
                      dry_run: bool = None) -> bool:
        """
        ...
        if not self.available:
            ...
            print(f"  Modificateur: {modifier.__name__ if hasattr(modifier, '__name__') else 'fonction'}")
            return True
    ...
    def preview_changes(self, file_path: Union[str, Path],
                       selector: str, modifier: callable) -> str:
        """
...
if __name__ == "__main__":
    ...
    if integration.check_availability():
        ...
        preview = integration.preview_changes(file_path, selector, print_to_logging_modifier)
