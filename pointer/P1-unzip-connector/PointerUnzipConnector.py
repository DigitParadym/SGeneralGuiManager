...
# Paths to utilities
UNZIP_UTILITY_PATH = os.path.abspath(os.path.join(script_dir, "..", "..", "SUnZip", "unzip_utility.py"))
CONNECTOR_PRO_PATH = os.path.abspath(os.path.join(script_dir, "..", "..", "connectorpro", "main.py"))

# Log resolved paths for debugging
logger.info(f"Resolved path to unzip utility: {UNZIP_UTILITY_PATH}")
logger.info(f"Resolved path to connector utility: {CONNECTOR_PRO_PATH}")

# Check if paths exist
if not os.path.exists(UNZIP_UTILITY_PATH):
    logger.error(f"Unzip utility not found at: {UNZIP_UTILITY_PATH}")
    raise FileNotFoundError(f"Unzip utility not found at: {UNZIP_UTILITY_PATH}")
if not os.path.exists(CONNECTOR_PRO_PATH):
    logger.error(f"Connector utility not found at: {CONNECTOR_PRO_PATH}")
    raise FileNotFoundError(f"Connector utility not found at: {CONNECTOR_PRO_PATH}")
